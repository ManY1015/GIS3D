...
// GIS3DView.cpp: CGIS3DView ï¿½ï¿½ï¿½Êµï¿½ï¿?
//
...
// CGIS3DView ï¿½ï¿½ï¿½ï¿½/ï¿½ï¿½ï¿½ï¿½

CGIS3DView::CGIS3DView() noexcept
{
	// TODO: ï¿½Ú´Ë´ï¿½ï¿½ï¿½Ó¹ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
...
void CGIS3DView::OnDraw(CDC* /*pDC*/)
{
	...
	// TODO: ï¿½Ú´Ë´ï¿½Îªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ó»ï¿½ï¿½Æ´ï¿½ï¿½ï¿?
}
...
{
	// TODO: ï¿½ï¿½Ó¶ï¿½ï¿½ï¿½Ä´ï¿½Ó¡Ç°ï¿½ï¿½ï¿½ÐµÄ³ï¿½Ê¼ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
}

void CGIS3DView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: ï¿½ï¿½Ó´ï¿½Ó¡ï¿½ï¿½ï¿½ï¿½Ðµï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
}

void CGIS3DView::OnRButtonUp(UINT /* nFlags */, CPoint /* point */)
{
	// ï¿½Ò¼ï¿½ï¿½ï¿½×§ï¿½ï¿½ï¿½ï¿½ OSG Ô­ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½âµ¯ï¿½ï¿½ï¿½Ëµï¿½ï¿½ï¿½ï¿½Æ½ï¿½Æ²ï¿½ï¿½ï¿½ï¿½ï¿½
}

void CGIS3DView::OnContextMenu(CWnd* /* pWnd */, CPoint /* point */)
{
	// ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Í¼ï¿½ï¿½ï¿½Ò¼ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ½ï¿½Æ£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ï¢Ó³ï¿½ï¿½ä»¯ï¿½ï¿?
}
...
CGIS3DDoc* CGIS3DView::GetDocument() const // ï¿½Çµï¿½ï¿½Ô°æ±¾ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
{
...
// CGIS3DView ï¿½ï¿½Ï¢ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
...
void CGIS3DView::OnInitialUpdate()
{
	...
	// TODO: ï¿½Ú´ï¿½ï¿½ï¿½ï¿½×¨ï¿½Ã´ï¿½ï¿½ï¿½ï¿½/ï¿½ï¿½ï¿½ï¿½Ã»ï¿½ï¿½ï¿?
...
{
	// TODO: ï¿½Ú´ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ï¢ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½/ï¿½ï¿½ï¿½ï¿½ï¿½Ä¬ï¿½ï¿½Ö?
	return true;
...
void CGIS3DView::ResumeRenderThread()
{
	...
	if (mThreadHandle)
	{
		...
		if (iSuspendCount == -1)
			;//ProcessErrorMessage("ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ú¼ï¿½ï¿½ï¿½ß³ï¿½");; 

		else
		{
			for (DWORD i = 0; i < static_cast<DWORD>(iSuspendCount); i++)//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Î£ï¿½ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä´ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ö¤Ö»ï¿½ï¿½ï¿½ï¿½Ò»ï¿½Î£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ê±ï¿½ß³Ì²ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
			{
...
void CGIS3DView::ResetTerrainWorkflow(bool bClearFiles)
{
	...
	m_strWorkflowLayerName = _T("µØÐÎ");
...
{
	CString strDemFilter = _T("DEMï¿½Ä¼ï¿½(*.tif;*.tiff;*.img;*.png;*.jpg;*.bmp)|*.tif;*.tiff;*.img;*.png;*.jpg;*.bmp|ï¿½ï¿½ï¿½ï¿½ï¿½Ä¼ï¿½(*.*)|*.*||");
	CFileDialog dlgDem(TRUE, NULL, NULL, OFN_HIDEREADONLY | OFN_FILEMUSTEXIST, strDemFilter, NULL);
	dlgDem.m_ofn.lpstrTitle = _T("Ñ¡ï¿½ï¿½DEMï¿½Ä¼ï¿½");
	...
	CString strImgFilter = _T("Ó°ï¿½ï¿½ï¿½Ä¼ï¿½(*.tif;*.tiff;*.jpg;*.jpeg;*.png;*.bmp)|*.tif;*.tiff;*.jpg;*.jpeg;*.png;*.bmp|ï¿½ï¿½ï¿½ï¿½ï¿½Ä¼ï¿½(*.*)|*.*||");
	CFileDialog dlgImg(TRUE, NULL, NULL, OFN_HIDEREADONLY | OFN_FILEMUSTEXIST, strImgFilter, NULL);
	dlgImg.m_ofn.lpstrTitle = _T("Ñ¡ï¿½ï¿½Ó°ï¿½ï¿½ï¿½Ä¼ï¿½ï¿½ï¿½ï¿½ï¿½È¡ï¿½ï¿½ï¿½ï¿½");
...
{
	// 1. Ñ¡ï¿½ï¿½ DEM ï¿½Ä¼ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ñ¡ï¿½ï¿½
	...
	// 2. Ñ¡ï¿½ï¿½Ó°ï¿½ï¿½ï¿½Ä¼ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½È¡ï¿½ï¿½ï¿½ï¿½
	CString strImage = _T("");
	...
	if (!info.pObject)
	{
		AfxMessageBox(_T("ï¿½ï¿½ï¿½Î¼ï¿½ï¿½ï¿½Ê§ï¿½Ü£ï¿½ï¿½ï¿½ï¿½ï¿½ DEM ï¿½Ä¼ï¿½ï¿½ï¿½Ê½ï¿½Ç·ï¿½ï¿½ï¿½È·ï¿½ï¿½"), MB_OK | MB_ICONERROR);
		return;
	}

	lstrcpy(info.szLayerName, _T("µØÐÎ"));
	AddEvent(info);
	CMainFrame* pFrame = DYNAMIC_DOWNCAST(CMainFrame, AfxGetMainWnd());
	if (pFrame)
...
void CGIS3DView::OnExpSaveBookmark()
{
	...
	if (EnsureExperimentFeatures() && m_pExperimentFeatures->SaveBookmark(strMsg))
		...
		UpdateTerrainStatus(strMsg.IsEmpty() ? _T("ï¿½Ó½ï¿½ï¿½ï¿½Ç©ï¿½ï¿½ï¿½ï¿½Ê§ï¿½Ü¡ï¿½") : strMsg);
}
...
void CGIS3DView::OnExpRestoreBookmark()
{
	...
	if (EnsureExperimentFeatures() && m_pExperimentFeatures->RestoreBookmark(strMsg))
		...
		UpdateTerrainStatus(strMsg.IsEmpty() ? _T("ï¿½Ó½ï¿½ï¿½ï¿½Ç©ï¿½Ö¸ï¿½Ê§ï¿½Ü¡ï¿½") : strMsg);
}
...
void CGIS3DView::OnExpBatchOverview()
{
	...
	if (EnsureExperimentFeatures() && m_pExperimentFeatures->FocusBatchModels(strMsg))
		...
		UpdateTerrainStatus(strMsg.IsEmpty() ? _T("ï¿½ï¿½ï¿½ï¿½Ä£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ê§ï¿½Ü¡ï¿½") : strMsg);
}
...
void CGIS3DView::OnExpScreenshot()
{
	...
	if (EnsureExperimentFeatures() && m_pExperimentFeatures->ExportScreenshot(strMsg))
		...
		UpdateTerrainStatus(strMsg.IsEmpty() ? _T("ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Í¼ï¿½ï¿½ï¿½ï¿½Ê§ï¿½Ü¡ï¿½") : strMsg);
}
...
void CGIS3DView::OnExpObjectInspect()
{
	...
	if (EnsureExperimentFeatures() && m_pExperimentFeatures->ToggleInspector(strMsg))
		...
		UpdateTerrainStatus(strMsg.IsEmpty() ? _T("ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ô²ï¿½Ñ¯ï¿½Ð»ï¿½Ê§ï¿½Ü¡ï¿½") : strMsg);
}
...
void CGIS3DView::OnExpTerrainQuery()
{
	...
	if (m_OSG && m_OSG->getRoot())
	{
		...
		for (unsigned int i = 0; i < pRoot->getNumChildren(); ++i)
		{
			...
			if (strName.Find(_T("µØÐÎ")) >= 0 || strName.Find(_T("Terrain")) >= 0 || strName.Find(_T("terrain")) >= 0)
			{
	...
	if (EnsureExperimentFeatures() && m_pExperimentFeatures->ToggleTerrainQuery(strMsg))
	{
		...
		AfxMessageBox(bEnabled
			? _T("ÒÑ½øÈëµØÐÎ¸ß³Ì²éÑ¯Ä£Ê½£¬Çë×ó¼üµã»÷µØÐÎ±íÃæ²éÑ¯¸ß³Ì¡£")
			: _T("ÒÑÍË³öµØÐÎ¸ß³Ì²éÑ¯Ä£Ê½¡£"),
			MB_OK | MB_ICONINFORMATION);
	}
	else
	{
		UpdateTerrainStatus(strMsg.IsEmpty() ? _T("ï¿½ï¿½ï¿½Î¸ß³Ì²ï¿½Ñ¯ï¿½Ð»ï¿½Ê§ï¿½Ü¡ï¿½") : strMsg);
